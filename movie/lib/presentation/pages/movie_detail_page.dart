...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context.read<WatchlistMovieBloc>().add(LoadWatchlistMovieStatus(widget.id));
    });
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            BlocConsumer<WatchlistMovieBloc, WatchlistMovieState>(
                              listenWhen: (previous, current) => current is WatchlistMovieMessage || current is WatchlistMovieError,
                              ...
                              buildWhen: (previous, current) => current is WatchlistMovieStatusLoaded,
                              builder: (context, state) {
                                ...
                                return FilledButton(
                                  onPressed: () async {
                                    if (!isAddedWatchlist) {
                                      context.read<WatchlistMovieBloc>().add(AddMovieToWatchlist(movie));
                                    } else {
                                      context.read<WatchlistMovieBloc>().add(RemoveMovieFromWatchlist(movie));
                                    }
                                  },
                                  child: Row(
